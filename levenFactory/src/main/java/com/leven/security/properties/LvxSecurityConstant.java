 ...
 */
public class LvxSecurityConstant {
     ...
     *
     */
    public static final String DEFAULT_UNAUTHENTICATION_URL = "/login";
    /**
     * 默认的用户名密码登录请求处理url
     */
    public static final String DEFAULT_LOGIN_PROCESSING_URL_FORM = "/lvx/login";
    /**
     * 默认的手机验证码登录请求处理url
     */
